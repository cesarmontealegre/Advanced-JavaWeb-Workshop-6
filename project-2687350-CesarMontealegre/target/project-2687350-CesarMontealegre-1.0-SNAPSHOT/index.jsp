...
<head>
    ...
    <!-- description -->
    <meta name="description" content="Formulario de Inicio de sesión de usuarios en Java Web Jakarta. Ingresa información personal y comienza a disfrutar de nuestros servicios con seguridad garantizada." />
    <!-- keywords -->
    <meta name="keywords" content="Inicio de sesión de usuarto, formulario de Inicio de sesión, crear cuenta, Inicio de sesión en línea" />
    <!-- minium responsive viewport -->
    <meta name="viewport " content="width=device-width, initial-scale=1.0 " />
    <!-- TITLE -->
    <title>Inicio de sesión de Usuario || My App Form</title>
    <!-- FAVICON -->
...
<main class="form w-100 m-auto">
    <form action="" method="post">
        ...
        <div id="link">
            <a href="${pageContext.request.contextPath}/registerUsers">Registrarse</a>
        </div>
    </form>
</main>
